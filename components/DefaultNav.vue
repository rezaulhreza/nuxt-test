<template>
  ...
  >
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <nuxt-link
        to="/"
        class="flex items-center py-4 text-gray-800 dark:text-gray-200"
      >
        <svg class="w-8 h-8 mr-2 fill-current" viewBox="0 0 24 24">
          <path
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
        ...
        >
          <li>
            <nuxt-link
              to="/"
              class="block px-4 py-2 text-gray-700 rounded-lg md:px-0 md:py-0 md:text-blue-700 md:hover:text-blue-700 dark:text-gray-400 md:dark:hover:text-white md:dark:focus:text-white"
              >Home</nuxt-link
            >
          </li>
          <li>
